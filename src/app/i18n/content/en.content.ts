...
export const EN_CONTENT: SiteContent = {
  ...
  theftAndDestruction: {
    kicker: 'Case file — repeat offender',
    title: 'THEFT AND DESTRUCTION',
    locationLabel: 'LOCATION',
    locationVal: 'Multiple locations — yard, living room',
    suspectLabel: 'SUSPECT',
    suspectVal: 'Le Criminel',
    witnessLabel: 'WITNESS',
    witnessVal: 'Sawito',
    motiveLabel: 'MOTIVE',
    motiveVal: 'Undetermined; suspect has priors',
    p1: 'Investigators have now logged three separate incidents attributed to the same suspect, spanning both outdoor and indoor property. In each case the pattern is consistent: an item is acquired without permission, and no attempt is made to conceal the act afterward. Cooperation with the witness has been minimal.',
    p2: 'Exhibit A, pictured, was recovered mid-theft: suspect apprehended holding a green shoe, laces already compromised, maintaining direct eye contact throughout questioning. No signs of remorse were observed. Additional exhibits (below) document a football rendered unrecognizable and a slice of bread removed from the kitchen without incident report.',
    exhibitBCaption: 'EXHIBIT B — THE BREAD. NO LEADS ON REMAINING SLICES.',
    exhibitCCaption: 'EXHIBIT C — THE FOOTBALL, AFTER.',
    stamp: 'PATTERN CONFIRMED — CASE REMAINS OPEN',
  },
  blog: {
    title: 'CASE LOG',
